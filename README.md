...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=3AFF75&width=435&lines=Greetings!!!;I'm+Mahmoud;FullStack+Engineer+with+expertise+in+;+Machine++learning+%26+Deep+learning;Passionate+about+building+scalable;and+efficient+systems;specialize+in+both+backend+and;+frontend+development%2C;and+I'm+always+;exploring++new+ways+to+integrate;cutting-edge+AI+technologies+;into+my+projects.)](https://git.io/typing-svg)
